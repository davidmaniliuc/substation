//! Exposes the offline-compiled display shader to Swift as a byte blob.
//!
...
const metallib = @embedFile("display_metallib");

export fn ps1_display_metallib_ptr() [*]const u8 {
    return metallib.ptr;
}

export fn ps1_display_metallib_len() usize {
    return metallib.len;
}
