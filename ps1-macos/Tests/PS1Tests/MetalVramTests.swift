...
@Test func theInstanceRecordLayoutIsWhatTheShaderAsserts() {
    // The Metal side carries `static_assert(sizeof(Ps1PrimInstance) == 4 * 54)`.
    ...
    #expect(MemoryLayout<Ps1PrimInstance>.stride == 4 * 54)
    #expect(MemoryLayout<Ps1PrimInstance>.size == 4 * 54)
}
